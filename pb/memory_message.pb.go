...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=goprojects.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb2, 0x01, 0x0a, 0x06, 0x4d, 0x65,
	...
	0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x67, 0x6f, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: goprojects.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: goprojects.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: goprojects.pcbook.Memory.unit:type_name -> goprojects.pcbook.Memory.Unit
